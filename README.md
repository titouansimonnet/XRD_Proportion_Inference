...
```
Here is an example in order to generate a single phase XRD pattern for Calcite. Others single phases XRD pattern can be generated by recovering CIF file on [AMSCD](https://www.rruff.net/amcsd/), and then by changing the parameters 'name' in the Python script.
